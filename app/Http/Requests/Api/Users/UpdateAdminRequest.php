    ...
    public function rules(): array
    {
        return [
            ...
            'username' => [
                ...
                'string',
                'max:16',
                'unique:admins,username,' . $this->route('id'),
            ...
            'personal_email' => [
                ...
                'email:rfc,dns',
                'max:100',
                'unique:admins,personal_email,' . $this->route('id'),
                'unique:users,personal_email,' . $this->route('id'),
            ],
            ...
            'company_email' => [
                ...
                'email:rfc,dns',
                'max:100',
                'unique:admins,company_email,' . $this->route('id'),
                'unique:users.company_email,' . $this->route('id'),
            ],
            ...
            'mobile_number' => [
                ...
                'starts_with:6,7,8,9',
                'regex:/^[0-9]{10}$/',
                'unique:admins,mobile_number,' . $this->route('id'),
            ],
            ...
            'alternate_mobile_number' => [
                ...
                'starts_with:6,7,8,9',
                'regex:/^[0-9]{10}$/',
                'unique:admins,alternate_mobile_number,' . $this->route('id'),
            ],
        ];
    }
